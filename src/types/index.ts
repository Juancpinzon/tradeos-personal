...
export type SetupType = 'breakout' | 'pullback' | 'earnings_play' | 'swing' | 'reversal' | 'other'
export type EmotionalState = 'calm' | 'excited' | 'fearful' | 'uncertain' | 'confident'
export type PostEmotionalState = 'satisfied' | 'regretful' | 'neutral' | 'anxious' | 'relieved'
